...
export class CollegeGamesComponent {
  games = [
    ...
    { date: '10/05/2024 3:30', opponent: '@ Iowa' },
    { date: '10/12/2024 7:30', opponent: '@ Oregon' },
  ...
  foodSchedule = [
    ...
    { food: 'Celebrity Guest Chef Beth Kovach', cocktail: 'Sloppy Joes' },
    { food: 'Smash Oregon Burgers', cocktail: 'BYOB' },
    { food: 'TBD' },
